...
{
    public partial class tylercalderonContext : DbContext
    {
        public tylercalderonContext()
        {
        }

        public tylercalderonContext(DbContextOptions<tylercalderonContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseMySql("server=codeboxx.cq6zrczewpu2.us-east-1.rds.amazonaws.com;database=tylercalderon;user=codeboxx;password=Codeboxx1!;treattinyasboolean=true", Microsoft.EntityFrameworkCore.ServerVersion.Parse("5.7.33-mysql"));
            }
        }
